    ...
    <div style={{
      ...
      <nav style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexShrink: 0 }}>
          <span className="focus-logo-arrow-wrap">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="24" height="24" className="focus-logo-arrow" style={{ display: 'block', flexShrink: 0 }}>
              <g transform="translate(5.33,5.33) scale(0.889)" fill="none" stroke="#b5f23a" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round">
