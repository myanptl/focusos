...
export default function LandingV2() {
  ...
  return (
    <div style={{
      ...
      {/* ════ STORY SCROLL ════════════════════════════════════════ */}
      {/* On mobile, skip FlowArt (GSAP ScrollTrigger pin) to prevent height/overflow issues */}
      <div id="v2-story" style={{ position: 'relative', zIndex: 1 }}>
        {(() => {
          const storyContent = (
            <>
              {/* Section 1 – Adaptive Timer: text left, timer right */}
              <FlowSection aria-label="Adaptive Timer" style={{ background: '#0d0d0f', flexDirection: isMobile ? 'column' : 'row', alignItems: isMobile ? 'flex-start' : 'stretch', justifyContent: 'flex-start', padding: 0, gap: 0 }}>
                <div style={{ flex: '1 1 50%', display: 'flex', flexDirection: 'column', justifyContent: 'center', gap: 'clamp(20px,3vh,36px)', padding: isMobile ? '48px 20px 24px' : 'clamp(48px,7vw,96px) clamp(32px,4vw,64px)' }}>
                  <div style={{ fontSize: 11, fontWeight: 700, letterSpacing: '0.16em', color: 'rgba(181,242,58,0.6)', textTransform: 'uppercase' }}>
                    01 — ADAPTIVE TIMER
                  </div>
                  <h2 style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: isMobile ? 'clamp(48px,12vw,72px)' : 'clamp(56px,7vw,112px)', fontWeight: 400, lineHeight: 0.88, letterSpacing: '0.01em', color: '#f0f0f2' }}>
                ...
                <div style={{ flex: '1 1 50%', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: isMobile ? '0 20px 48px' : 'clamp(48px,7vw,96px) clamp(32px,4vw,64px)' }}>
                  <TimerVisual />
                </div>
              </FlowSection>

              {/* Section 2 – AI Quiz: quiz left, text right */}
              <FlowSection aria-label="AI Quiz" style={{ background: '#0b1a09', flexDirection: isMobile ? 'column' : 'row', alignItems: isMobile ? 'flex-start' : 'stretch', justifyContent: 'flex-start', padding: 0, gap: 0 }}>
                <div style={{ flex: '1 1 50%', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: isMobile ? '48px 20px 24px' : 'clamp(48px,7vw,96px) clamp(32px,4vw,64px)' }}>
                  <QuizVisual />
                </div>
                <div style={{ flex: '1 1 50%', display: 'flex', flexDirection: 'column', justifyContent: 'center', gap: 'clamp(20px,3vh,36px)', padding: isMobile ? '0 20px 48px' : 'clamp(48px,7vw,96px) clamp(32px,4vw,64px)' }}>
                  <div style={{ fontSize: 11, fontWeight: 700, letterSpacing: '0.16em', color: 'rgba(181,242,58,0.6)', textTransform: 'uppercase' }}>
                    02 — AI QUIZ
                  </div>
                  <h2 style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: isMobile ? 'clamp(48px,12vw,72px)' : 'clamp(56px,7vw,112px)', fontWeight: 400, lineHeight: 0.88, letterSpacing: '0.01em', color: '#f0f0f2' }}>
              ...
              <FlowSection aria-label="Goals and Streaks" style={{ background: '#0f0e19', flexDirection: isMobile ? 'column' : 'row', alignItems: isMobile ? 'flex-start' : 'stretch', justifyContent: 'flex-start', padding: 0, gap: 0 }}>
                <div style={{ flex: '1 1 50%', display: 'flex', flexDirection: 'column', justifyContent: 'center', gap: 'clamp(20px,3vh,36px)', padding: isMobile ? '48px 20px 24px' : 'clamp(48px,7vw,96px) clamp(32px,4vw,64px)' }}>
                  <div style={{ fontSize: 11, fontWeight: 700, letterSpacing: '0.16em', color: 'rgba(181,242,58,0.6)', textTransform: 'uppercase' }}>
                    03 — GOALS &amp; STREAKS
                  </div>
              ...
              <FlowSection aria-label="Free to Start" style={{ background: '#060608', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', textAlign: 'center', padding: 'clamp(48px,7vw,96px) clamp(20px,5vw,56px)' }}>
                <div style={{ maxWidth: 640, padding: '0 clamp(20px,5vw,56px)', width: '100%' }}>
                  ...
                  <h2 style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: isMobile ? 'clamp(48px,12vw,72px)' : 'clamp(52px,8vw,112px)', fontWeight: 400, lineHeight: 0.92, letterSpacing: '0.01em', color: '#f0f0f2', marginBottom: 20 }}>
                  ...
                  <RippleButton
                    ...
                    style={{ fontSize: 16, padding: '15px 36px', width: isMobile ? '100%' : 'auto' }}
          ...
          return isMobile
            ? <main style={{ width: '100%', overflowX: 'hidden' }}>{storyContent}</main>
            : <FlowArt>{storyContent}</FlowArt>
        })()}
        <div aria-hidden style={{
      ...
      <section style={{
        ...
        <div style={{ position: 'relative', zIndex: 1 }}>
          <FadeUp>
            ...
            <RippleButton
              className="l-btn-primary"
              style={{ fontSize: 16, padding: '15px 36px', margin: '0 auto', width: isMobile ? '100%' : 'auto' }}
              onClick={() => navigate(ctaTarget)}
            >
