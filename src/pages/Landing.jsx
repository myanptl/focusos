...
function OrbBackground() {
  ...
  const orbs = [
    { w: 660, h: 580, left: '-12%', top:  '0%',  dur: 32, ax: [0, 65, -30, 0], ay: [0, -55, 35, 0], op: 0.045 },
    { w: 500, h: 500, left:  '58%', top: '-10%',  dur: 27, ax: [0, -45, 55, 0], ay: [0, 48, -28, 0], op: 0.035 },
    { w: 380, h: 380, left:  '28%', top:  '58%',  dur: 38, ax: [0, 38, -50, 0], ay: [0, -38, 22, 0], op: 0.028 },
  ]
